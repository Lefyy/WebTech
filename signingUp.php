                        ...
                        <form action="php/register.php" method="post">
                            <div class="wrapperSign">
                                ...
                                <div>
                                    ...
                                    <input type="password" placeholder="Повтор пароля" name="passrepeat" style="padding: 5px;"> <br>
                                </div>
                                <button type="submit" class="btn btn-style" style="width: 180px; height: 40px;">Зарегистрироваться</button>
                                <div style="font-size: 14px;">
                                    Уже зарегистрированы? <a href="signingIn.php">Авторизуйтесь!</a>
                                </div>
                            </div>
                        </form>
                    </div>
